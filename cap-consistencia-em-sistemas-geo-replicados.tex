...
exemplo.  Reordenação ocorre quando pacotes de uma mesma conexão TCP enviados
nos instantes T1 e T2 seguem caminhos diferentes na rede, e o pacote enviado em
T2 chega ao receptor antes do enviado em T1. Duplicação normalmente está
...
transmissão é linear, e não mais exponencial como no início lento. Existem
muitas outras opções de algoritmos de prevenção de congestionamento, entre elas
duas são de interesse particular para este trabalho por focarem em redes com
latência e largura de banda grandes.
