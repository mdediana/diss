...
\ref{sec:rede}. A carga sobre o sistema é definida pela aplicação de execução
dos testes, descrita na subseção \ref{sec:benchmark}.
...
\ref{sec:benchmark}). O Voldemort também possui aplicação semelhante, mas ela
