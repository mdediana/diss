...
criados, um por centro de dados. Um deles é colocado em todos os servidores de
CD1 e o outro em todos os servidores de CD2. A partir dessa configuração, os
...
distinção entre servidores executando instâncias do Riak ou do Basho Bench é
