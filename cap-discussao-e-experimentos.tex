...
para os experimentos a diferença entre leituras e escritas. Escritas podem
ser divididas em inserções, atualizações e remoções. Todas elas se comportam da
...
localização de cada nó com relação aos centros de dados e quando
a terceira escrita vinda de um centro de dados diferente do em que está o mestre
acontece o migram para lá. As inserções são ineficientes, ocorrendo sempre pela mesma réplica, mesmo que em
outro centro de dados. Isso foi feito para evitar conflitos de inserção.
