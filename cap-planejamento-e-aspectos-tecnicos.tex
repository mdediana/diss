...
sistema eram divididos em dois conjuntos CD1 e CD2, cada um representando um
...
requisições que saíam de um centro de processamento de dados para o outro usavam
o IP da sub-rede de destino, enquanto as requisições para o mesmo centro de
processamento de dados usavam o IP da rede do Grid5000.
