...
/etc/hosts dos nós de CPD1 e CPD2 respectivamente. O conteúdo de hosts1 eram os
nomes dos nós de CPD2 sendo resolvidos para os IPs de SR2, o mesmo valendo para
hosts2, CPD1 e SR1. Com isso, os nós de CPD1 resolviam os nomes dos nós de CPD2
