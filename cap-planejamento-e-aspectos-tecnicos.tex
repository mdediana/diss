...
\ref{sec:experimentos_fatoriais}.
...
estudo experimental. A segunda referência usada sobre análise de desempenho foi \cite{Lilja2005}.

Neste trabalho seguimos os passos da abordagem em \cite{Jain1991}, com
...
complexidade do estudo, inclusive estando descrita em um capítulo à parte
...
Para esses casos, um tipo particular de projeto de experimentos fatoriais
completo é utilizado para fazer uma triagem dos fatores, identificando quais
deles são os mais influentes. Esse tipo está descrito na subseção a seguir.

%% ------------------------------------------------------------------------- %%
\subsection{Projeto de experimentos fatoriais 2\textsuperscript{k}}
\label{sec:projeto_de_experimentos_fatoriais_2k}
