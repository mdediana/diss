...
Os fatores desta seção foram escolhidos de forma a aproximar este estudo dos
ambientes de produção de sistemas web geo-replicados, assim fatores que afetam o
desempenho do sistema operando sobre WAN foram priorizados. Os fatores
