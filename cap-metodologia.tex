...
finais. Os experimentos intermediários estão descritos em
\ref{sec:experimentos_intermediarios}.
...
são tratados como um único, chamado modo.
...
%% ------------------------------------------------------------------------- %%
\subsubsection{CPU local e CPU remota} \label{sec:cpu_local_e_cpu_remota}
%% ------------------------------------------------------------------------- %%
\subsubsection{Quantidade de memória local e remota}
\label{sec:quantidade_de_memoria_local_e_remota}
%% ------------------------------------------------------------------------- %%
\subsubsection{Mecanismo de armazenamento -- memória ou disco}
\label{mecanismo_de_armazenamento}
%% ------------------------------------------------------------------------- %%
\subsubsection{Desempenhos de acesso sequencial de leitura e de escrita do disco
(para disco como mecanismo de armazenamento)}
\label{desempenhos_de_acesso_sequencial_de_leitura_e_de_escrita_do_disco}
%% ------------------------------------------------------------------------- %%
\subsubsection{Desempenhos de acesso aleatório de leitura e de escrita do disco
(para disco como mecanismo de armazenamento)}
\label{desempenhos_de_acesso_aleatorio_de_leitura_e_de_escrita_do_disco}
...
Singapura. A partir disso, os níveis para latência da WAN são:
...
A partir disso, dois níveis de variação foram propostos inicialmente:

\begin{itemize} \item 1\% \item 50\% \end{itemize}

Os níveis de correlação usados foram:

\begin{itemize} \item Nenhuma correlação \item Distribuição normal \end{itemize}

Após os experimentos intermediários esses valores foram fixados (ver seção
\ref{sec:experimentos_intermediarios}).
...
%% ------------------------------------------------------------------------- %%
\subsubsection{Taxa de perda de duplicação de pacotes da WAN}
