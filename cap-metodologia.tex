...
podem afetar o desempenho do sistema, como a CPU ou a latência da rede.
...
produção de sistemas web geo-replicados, assim fatores que afetam o
desempenho do sistema operando sobre WAN foram priorizados. Apesar disso,
...
afetar a quantidade de conflitos, já que quanto menos objetos existirem no
...
\paragraph{Relação entre largura de banda e latência (Produto Banda-Latência --
BDP) }A quantidade de dados em trânsito em uma conexão TCP é dada pelo Produto
...
é o tamanho dos buffers de transmissão e recepção. Referências sobre otimização
da pilha TCP para WANs sugerem que o tamanho ideal para esses buffers é o dobro
do BDP.
