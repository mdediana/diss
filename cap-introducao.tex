...
para o usuário, que precisa refazer uma operação por exemplo. Os casos mais
complicados precisam de ações de compensação, como o estorno do valor de um item
que o usuário não queria ter comprado.
...
indisponibilidade curta pode ser tolerada pelos usuários.
...
problema de itens ressurgirem não aconteceria. Por outro lado, um usuário
poderia ser impedido de adicionar novos itens a seu carrinho de compras
temporariamente caso a réplica mestre ficasse indisponível.
...
a consistência na linha do tempo é pouco usada e reconhecida \cite{Abadi2010} --
em julho de 2012, foram encontrados apenas dois sistemas na literatura e nenhum
projeto de software livre usando esse tipo de consistência
...
realizadas. O Capítulo~\ref{cap:planejamento} contempla o planejamento dos
experimentos. A seguir, o Capítulo~\ref{cap:parametros_e_fatores} descreve o
...
Depois, o Capítulo~\ref{cap:aspectos_tecnicos} trata dos aspectos técnicos da
implementação dos experimentos. O Capítulo~\ref{cap:analise_dos_resultados}
aborda a análise dos resultados obtidos nos experimentos. Por fim, o
Capítulo~\ref{cap:conclusoes} traz as conclusões deste trabalho.
