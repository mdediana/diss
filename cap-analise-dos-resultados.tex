...
resposta, a Seção~\ref{sec:analise_dos_conflitos}, a análise dos conflitos
e a Seção~\ref{sec:analise_das_migracoes}, a análise das migrações. A
Seção~\ref{sec:ameacas_a_validade} descreve as ameaças à validade levantadas e, por fim, a Seção~\ref{sec:trabalhos_relacionados} apresenta os trabalhos
relacionados.
...
experimentos. Com precisão de 1\%, apenas
...
latência 60\% ele precisaria de 83030 mas tinha 76137. Se considerado o mesmo
nível de confiança, mas exatidão de 2\%, todos os
experimentos tinham o tamanho da amostra suficiente.
...
explicação possível seria alguma sobrecarga no sistema, mas nesse caso
...
Os ganhos relativos para requisições remotas da consistência na linha
...
\end{tabular} \caption[Ganhos relativos entre modos.]{Ganhos relativos dos tempos de resposta para os modos \emph{lt\_qqer} e lt\_lat com
relação a \emph{ind2} para latência de 200 ms. O sinal negativo indica perdas.} \label{tab:ganhos_e_perdas_relativos_das_requisicoes_remotas}
\end{center} \end{table}

Com relação ao percentil 75 e localidade de 50\%, os ganhos são altos pois
