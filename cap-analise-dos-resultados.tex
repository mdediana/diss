...
os experimentos para \emph{lt\_rec}, localidade de 50\% e latência de rede 300 ms
...
No caso de escritas e localidade de 50\%, \emph{lt\_rec} apresenta um desempenho um
...
exemplo, para \emph{ind1}, localidade de 50\% e latência de 0 ms, o percentil 91 é 3,8
...
Com relação ao percentil 75 e localidade de 50\%, os ganhos são tão altos pois as
...
de 30\%, para todos os casos com latência diferente de 0 ms e variação
