...
Seção~\ref{sec:nivel_de_confianca,_exatidao_e_tamanho_da_amostra} descreve o
...
exemplo, para \emph{ind1}, localidade 50\% e latência 0 ms, o percentil 91 é 3,8
ms e o percentil 92 é 38,0 ms. A partir daí, os tempos de resposta crescem
...
centro de processamento de dados é grande, portanto a escrita acontece no centro
de processamento de dados local antes. Já no caso em que a variação da latência
é 60\%, existe uma chance razoável de a escrita chegar ao outro centro de
processamento de dados antes da leitura. Nesses casos, a leitura que aconteceu
antes da escrita lê o valor remoto mais novo, compara com o mais antigo e
portanto resulta em conflito.
