...
A principal hipótese deste trabalho era que um sistema geo-replicado usando consistência na
...
%e a variação da rede é a maior. Esse experimento é o que tem modo lt\_rec e
...
No caso de leituras e localidade 50\%, apenas lt\_rec apresenta requisições
...
localidade 90\% beneficia lt\_rec, que continua
apresentando tempos de resposta mais altos que os outros modos. O degrau que
aparecia nos gráficos para latência de 0 ms permanece, mas no caso de lt\_rec ele
...
No caso de escritas e localidade 50\%, lt\_rec apresenta um desempenho um pouco
melhor que ev2 e lt\_qqer. A explicação provável para isso é o fato de o sistema
estar menos carregado para esse modo do que os outros, o que acontece pois as leituras de lt\_rec são mais lentas. Esse fato pode ser
comprovado pela vazão dos modos lt\_rec, ev2 e lt\_qqer, respectivamente, 594,
1072, 941 operações/s. Já no caso de localidade 0,9, lt\_rec e lt\_qqer se
