...
pesquisador queira reproduzir o estudo no Grid'5000, ele tem disponíveis os
...
e está documentada (ver Seção \ref{sec:ambiente_e_imagem}). Além disso, alguns
...
\paragraph{Influência de fatores em sistemas de armazenamento}Conhecer quais
fatores afetam ou não o desempenho de um sistema de armazenamento ajuda
desenvolvedores e administradores de sistemas em decisões sobre planejamento de
capacidade e desenvolvimento do sistema (como otimizações, por exemplo).
...
trabalho com a operação no Grid'5000 influenciar a decisão sobre o tamanho do
...
influentes (\emph{jitter}, por exemplo).  Além disso, era composta por 420
experimentos que demoravam aproximadamente 24h para serem executados, contra os
64 experimentos e 6,5h da segunda versão do estudo, redução que aconteceu pelo
